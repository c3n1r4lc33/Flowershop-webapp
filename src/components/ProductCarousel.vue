<template>
  <div class="carousel" @mouseenter="pauseAutoSwipe" @mouseleave="resumeAutoSwipe">
...
export default {
  ...
  computed: {
    currentImage() {
      return this.product.images[this.currentIndex].replace('300x200', '600x400');
    }
  },
  mounted() {
    this.startAutoSwipe();
...
.thumbnails img:nth-child(1) { --i: 1; }
.thumbnails img:nth-child(2) { --i: 2; }
